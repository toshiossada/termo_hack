...
// in termo/test/app/modules/words/presentation/pages/home/home_controller_test.dart.
...
class MockFilterWordsUsecase extends _i1.Mock
  ...
  List<String> call({
    ...
    required _i5.WordEntity? wordEntity,
...
class MockIDialogAdapter extends _i1.Mock implements _i6.IDialogAdapter {
  ...
  @override
  void showDialog(_i7.Widget? child) => super.noSuchMethod(
        Invocation.method(
          #showDialog,
          [child],
        ),
...
/// A class which mocks [FilterPositionLettersUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockFilterPositionLettersUsecase extends _i1.Mock
    implements _i11.FilterPositionLettersUsecase {
  MockFilterPositionLettersUsecase() {
    _i1.throwOnMissingStub(this);
  }
